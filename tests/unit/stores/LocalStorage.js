define([
	...
	'../../../errors/StoreError',
	'../../../on'
], function (registerSuite, assert, LocalStorage, Promise, StoreError, on) {
	
	var store,
		all = Promise.all.bind(Promise);

	registerSuite({
		name: 'core/stores/LocalStorage',
		'creation': function () {
			...
			assert.instanceOf(store, LocalStorage);
		},
		'.get()': function () {
			var promises = [];
